...
std_curve_copies = 1.05 # What is the copies/µL *10^x of the standard dilution series
PCR_that_has_std_curve = 0 # Which PCR contains your standard dilution series
analytical_run_code = 'xc.b.rp' # Analytical run code generated by DAS
power_to_skip = [] # Which powers do you not want to use in your standard curve? fill in [1,2] for example if you want to skip 10^1 & 10^2
...
for file in file_names:
    ...
    PCRs[f'{PCR_number}'] = pd.read_csv(file, usecols=['Sample', 'Cq', 'Content', 'Starting Quantity (SQ)'])
...
stdcurve = PCRs['PCR_' + str(PCR_that_has_std_curve)][PCRs['PCR_' + str(PCR_that_has_std_curve)]['Content'] == "Std"]
#%%
