...
with pd.ExcelWriter(excel_file_path, mode="a", engine="openpyxl") as writer:
    stdcurve.to_excel(writer, sheet_name = "Standard_curve2")
    
"""
# !!!Variables to set==========================================================
# =============================================================================
folder_path = 'C:/Users/rdebeer/OneDrive - NIOZ/Data/qPCR/Test_python' # Directory where the CSV files are located
...
# Creates a new excel with the right files
excel_file = Workbook()
...
plt.tight_layout()
plt.savefig(newpath +"/" + analytical_run_code + "_difference_to_mean.png")
plt.show()
# =============================================================================
# Excel formatting  ===========================================================
# =============================================================================
