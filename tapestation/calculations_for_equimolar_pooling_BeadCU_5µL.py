...
filepath = '//zeus.nioz.nl/mmb/molecular_ecology/mollab_team/Projects/2024/MMB/Pierre/NIOZ404_adjusted_compactRegionTable.csv'
...
#### What sample should be considered 
...
data['dilution_ratio'] = ''
samples_to_dilute = []
preferred_max_concentration = ng_per_sample / 5
...
if number_of_samples_to_dilute > 0:
    for sample in data.index:
        ...
        if dilution_ratio:
            ...
            for i in range(1,math.ceil(PCR_volume/5)):
                DNA_volume = 5 * i
...
data.to_csv(f'{filepath}{NIOZ_number}_equimolar_pooling_results_test.csv', index = False, encoding = 'ansi')
